...
opt$input_filename = snakemake@input[[1]]
opt$output_filename = snakemake@output[[1]]
...
# gp
ggsave(filename = opt$output_filename, width = opt$plot_size, height = opt$plot_size, units = "in", dpi = 300, limitsize = F)
